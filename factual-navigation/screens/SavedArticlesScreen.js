...
//push articles saved in database
...
export default class SavedArticlesScreen extends Component {
  ...
  updateSaved = (item) => {
    ...
    let index = arrayHolder.findIndex((el) => el.website_title === item.website_title);
          ...
          renderItem={({ item }) => (
            <Card
              ...
              <Card.Content>
                ...
                <Text
                  style={{ fontSize: 12, fontFamily: 'Avenir-Heavy', paddingBottom: 5 }}>
